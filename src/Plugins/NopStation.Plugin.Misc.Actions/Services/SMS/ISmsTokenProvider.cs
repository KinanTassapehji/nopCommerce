...
namespace NopStation.Plugin.Misc.Core.Services.SMS;
	...
	// ponytail: gift cards and recurring payments are not part of this fork
public interface ISmsTokenProvider
{
	...
	Task AddForumTopicTokensAsync(IList<Token> commonTokens, ForumTopic forumTopic, int? friendlyForumTopicPageIndex = null, int? appendedPostIdentifierAnchor = null);
