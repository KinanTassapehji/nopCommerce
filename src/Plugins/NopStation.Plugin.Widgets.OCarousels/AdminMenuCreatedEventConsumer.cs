...
public class AdminMenuCreatedEventConsumer : IConsumer<AdminMenuEvent>
{
	...
	{
		if (await _permissionService.AuthorizeAsync("ManageNopStationOCarousels"))
		{
			...
			nopStationAdminMenuItem2.Title = await _localizationService.GetResourceAsync("Admin.NopStation.OCarousels.Menu.OCarousel");
			...
			adminMenuItem2.Title = await _localizationService.GetResourceAsync("Admin.NopStation.OCarousels.Menu.Carousels");
			adminMenuItem.Url = "~/Admin/OCarousel/List";
			adminMenuItem.Visible = true;
			adminMenuItem.IconClass = "far fa-circle";
			adminMenuItem.SystemName = "OCarousels";
			menuItem.ChildNodes.Add(adminMenuItem);
			adminMenuItem2 = new AdminMenuItem();
			adminMenuItem = adminMenuItem2;
			adminMenuItem.Title = await _localizationService.GetResourceAsync("Admin.NopStation.OCarousels.Menu.Configuration");
			adminMenuItem2.Url = "~/Admin/OCarousel/Configure";
			adminMenuItem2.Visible = true;
			adminMenuItem2.IconClass = "far fa-circle";
			adminMenuItem2.SystemName = "OCarousels.Configuration";
			...
			if (await _permissionService.AuthorizeAsync("ShowNopStationDocumentations"))
			{
				...
				adminMenuItem.Url = "https://www.nop-station.com/ocarousel-documentation?utm_source=admin-panel?utm_source=admin-panel&utm_medium=products&utm_campaign=ocarousel";
				adminMenuItem.Visible = true;
				adminMenuItem.IconClass = "far fa-circle";
