...
public class OCarousel : BaseEntity, ILocalizedEntity, IStoreMappingSupported, ISoftDeletedEntity
{
	...
	public DataSourceTypeEnum DataSourceTypeEnum
	{
		get
		{
			return (DataSourceTypeEnum)DataSourceTypeId;
		}
		set
		{
			DataSourceTypeId = (int)value;
		}
	}
}
