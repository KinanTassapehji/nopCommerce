...
public record SliderModel : BaseNopEntityModel, ILocalizedModel<SliderLocalizedModel>, ILocalizedModel, IStoreMappingSupportedModel
{
	...
	[NopResourceDisplayName("Admin.NopStation.AnywhereSlider.Sliders.Fields.Margin")]
