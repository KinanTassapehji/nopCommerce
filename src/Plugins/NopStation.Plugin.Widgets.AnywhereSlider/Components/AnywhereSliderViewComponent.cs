...
public class AnywhereSliderViewComponent : NopStationViewComponent
{
	...
	public AnywhereSliderViewComponent(ISliderModelFactory sliderModelFactory, SliderSettings sliderSettings)
	{
	...
	public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
	{
		...
		return View(await _sliderModelFactory.PrepareSliderListModelAsync(widgetZoneId));
	}
}
