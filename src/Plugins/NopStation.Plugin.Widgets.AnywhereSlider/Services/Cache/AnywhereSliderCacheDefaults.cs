...
{
	public static CacheKey SliderItemsBySliderIdKey => new CacheKey("Nopstation.anywhereslider.slideritems.bysliderid.{0}");

	public static string SliderItemPrefix => "Nopstation.anywhereslider.slideritems.";

	public static CacheKey SlidersAllKey => new CacheKey("Nopstation.anywhereslider.sliders.all.{0}-{1}-{2}");
