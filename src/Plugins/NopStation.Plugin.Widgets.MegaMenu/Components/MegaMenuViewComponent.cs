...
public class MegaMenuViewComponent : NopStationViewComponent
{
	...
	public MegaMenuViewComponent(MegaMenuSettings megaMenuSettings, IMegaMenuModelFactory megaMenuModelFactory)
	{
	...
	{
		return View(await _megaMenuModelFactory.PrepareMegaMenuModelAsync());
	}
}
