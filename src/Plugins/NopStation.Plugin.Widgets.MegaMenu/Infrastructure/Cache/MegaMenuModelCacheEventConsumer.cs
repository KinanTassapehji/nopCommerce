...
public class MegaMenuModelCacheEventConsumer : IConsumer<EntityInsertedEvent<Manufacturer>>, IConsumer<EntityUpdatedEvent<Manufacturer>>, IConsumer<EntityDeletedEvent<Manufacturer>>, IConsumer<EntityInsertedEvent<Category>>, IConsumer<EntityUpdatedEvent<Category>>, IConsumer<EntityDeletedEvent<Category>>, IConsumer<EntityInsertedEvent<Topic>>, IConsumer<EntityUpdatedEvent<Topic>>, IConsumer<EntityDeletedEvent<Topic>>, IConsumer<EntityInsertedEvent<Setting>>, IConsumer<EntityUpdatedEvent<Setting>>, IConsumer<EntityDeletedEvent<Setting>>
{
	public static CacheKey MEGAMENU_TOPICS_MODEL_KEY = new CacheKey("Nopstation.megamenu.topic-{0}-{1}-{2}");

	public static CacheKey MEGAMENU_CATEGORIES_MODEL_KEY = new CacheKey("Nopstation.megamenu.categories-{0}-{1}-{2}");

	public static CacheKey MEGAMENU_MANUFACTURERS_MODEL_KEY = new CacheKey("Nopstation.megamenu.manufacturers-{0}-{1}-{2}");

	public static CacheKey MEGAMENU_MODEL_KEY = new CacheKey("Nopstation.megamenu.all-{0}-{1}-{2}");
	...
	{
		await _staticCacheManager.RemoveByPrefixAsync("Nopstation.megamenu.");
	}
