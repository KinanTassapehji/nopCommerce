...
public class ProductTabItemValidator : BaseNopValidator<ProductTabItemModel>
{
	...
	{
		RuleFor((ProductTabItemModel x) => x.Name).NotEmpty().WithMessage(localizationService.GetResourceAsync("Admin.NopStation.ProductTabs.ProductTabItems.Fields.Name.Required").Result);
	}
}
