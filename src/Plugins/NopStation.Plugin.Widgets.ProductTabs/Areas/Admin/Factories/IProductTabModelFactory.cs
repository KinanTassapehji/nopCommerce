...
public interface IProductTabModelFactory
{
	...
	Task<ProductTabModel> PrepareProductTabModelAsync(ProductTabModel model, ProductTab productTab, bool excludeProperties = false);
	...
	Task<ProductTabItemModel> PrepareProductTabItemModelAsync(ProductTabItemModel model, ProductTabItem productTabItem, ProductTab productTab, bool excludeProperties = false);

	Task<ProductTabItemProductListModel> PrepareProductTabItemProductListModelAsync(ProductTabItemProductSearchModel searchModel, ProductTabItem productTabItem);
