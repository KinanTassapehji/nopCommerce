...
public interface IProductTabService
{
	...
	Task<IPagedList<ProductTab>> GetAllProductTabsAsync(List<int> widgetZoneIds = null, bool hasItemsOnly = false, int storeId = 0, bool? active = null, int pageIndex = 0, int pageSize = int.MaxValue);
