...
public class ProductTabViewComponent : NopStationViewComponent
{
	...
	public ProductTabViewComponent(IProductTabModelFactory productTabModelFactory, ProductTabSettings productTabSettings)
	{
	...
	public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
	{
		...
		return View(await _productTabModelFactory.PrepareProductTabListModelAsync(widgetZone));
	}
}
