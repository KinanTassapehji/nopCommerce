...
public class MaintenanceRequestAdminLocalizationMigration : MigrationBase
{
    ...
    public override void Up()
    {
        ...
        localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
        {
            ...
            ["Admin.Sales.MaintenanceRequests.Fields.Email"] = "البريد الإلكتروني",
            ...
            ["Admin.Sales.MaintenanceRequests.List.Email"] = "البريد الإلكتروني",
            ["Admin.Sales.MaintenanceRequests.List.Email.Hint"] = "البحث بالبريد الإلكتروني.",
