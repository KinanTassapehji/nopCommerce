            ...
            ChildNodes = new List<AdminMenuItem>
            {
                ...
                new()
                {
                    ...
                    ChildNodes = new List<AdminMenuItem>
                    {
                        ...
                        new()
                        {
                            SystemName = "Maintenance requests",
                            Title = await _localizationService.GetResourceAsync("Admin.Sales.MaintenanceRequests"),
                            PermissionNames = new List<string> { StandardPermission.Orders.MAINTENANCE_REQUESTS_VIEW },
                            Url = GetMenuItemUrl("MaintenanceRequest", "List"),
                            IconClass = "far fa-dot-circle"
                        },
