...
//TmTm: page-transition loader. The store renders on the server, so a click
//leaves the browser on the old page with no feedback until the next document
//arrives; html.tm-navigating veils it, drawn by css/tm-loader.css.
...
window.addEventListener('beforeunload', function () {
    document.documentElement.classList.add('tm-navigating');
});

//Back/forward out of the bfcache restores the DOM exactly as it was unloaded,
//veil included.
window.addEventListener('pageshow', function () {
    document.documentElement.classList.remove('tm-navigating');
});
